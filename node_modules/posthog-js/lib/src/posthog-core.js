...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype.set_config = function (config) {
        ...
        if ((0, core_1.isObject)(config)) {
            ...
            (_e = this.autocapture) === null || _e === void 0 ? void 0 : _e.startIfEnabled();
            (_f = this.heatmaps) === null || _f === void 0 ? void 0 : _f.startIfEnabled();
            (_g = this.exceptionObserver) === null || _g === void 0 ? void 0 : _g.startIfEnabledOrStop();
            (_h = this.deadClicksAutocapture) === null || _h === void 0 ? void 0 : _h.startIfEnabledOrStop();
            (_j = this.surveys) === null || _j === void 0 ? void 0 : _j.loadIfEnabled();
            this._sync_opt_out_with_persistence();
            (_k = this.externalIntegrations) === null || _k === void 0 ? void 0 : _k.startIfEnabledOrStop();
        }
    };
    /**
     * @internal
