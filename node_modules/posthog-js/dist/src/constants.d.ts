...
export declare const PRODUCT_TOURS_ENABLED_SERVER_SIDE = "$product_tours_enabled_server_side";
...
export declare const SESSION_RECORDING_OVERRIDE_SAMPLING = "$replay_override_sampling";
export declare const SESSION_RECORDING_OVERRIDE_LINKED_FLAG = "$replay_override_linked_flag";
export declare const SESSION_RECORDING_OVERRIDE_URL_TRIGGER = "$replay_override_url_trigger";
export declare const SESSION_RECORDING_OVERRIDE_EVENT_TRIGGER = "$replay_override_event_trigger";
export declare const SESSION_ID = "$sesid";
export declare const SESSION_RECORDING_IS_SAMPLED = "$session_is_sampled";
export declare const SESSION_RECORDING_PAST_MINIMUM_DURATION = "$session_past_minimum_duration";
...
export declare const SESSION_RECORDING_TRIGGER_V2_GROUP_EVENT_PREFIX = "$posthog_sr_group_event_trigger_";
export declare const SESSION_RECORDING_TRIGGER_V2_GROUP_URL_PREFIX = "$posthog_sr_group_url_trigger_";
export declare const SESSION_RECORDING_TRIGGER_V2_GROUP_SAMPLING_PREFIX = "$posthog_sr_group_sampling_";
export declare const SESSION_RECORDING_FIRST_FULL_SNAPSHOT_TIMESTAMP = "$debug_first_full_snapshot_timestamp";
export declare const ENABLED_FEATURE_FLAGS = "$enabled_feature_flags";
export declare const PERSISTENCE_ACTIVE_FEATURE_FLAGS = "$active_feature_flags";
...
export declare const PERSISTENCE_FEATURE_FLAG_PAYLOADS = "$feature_flag_payloads";
export declare const PERSISTENCE_FEATURE_FLAG_REQUEST_ID = "$feature_flag_request_id";
export declare const PERSISTENCE_OVERRIDE_FEATURE_FLAGS = "$override_feature_flags";
export declare const PERSISTENCE_OVERRIDE_FEATURE_FLAG_PAYLOADS = "$override_feature_flag_payloads";
...
export declare const PRODUCT_TOURS = "ph_product_tours";
export declare const PRODUCT_TOURS_ACTIVATED = "$product_tours_activated";
export declare const CONVERSATIONS = "$conversations";
export declare const CONVERSATIONS_LEGACY_WIDGET_SESSION_ID = "$conversations_widget_session_id";
export declare const CONVERSATIONS_LEGACY_TICKET_ID = "$conversations_ticket_id";
export declare const CONVERSATIONS_LEGACY_WIDGET_STATE = "$conversations_widget_state";
export declare const CONVERSATIONS_LEGACY_USER_TRAITS = "$conversations_user_traits";
export declare const FLAG_CALL_REPORTED = "$flag_call_reported";
export declare const FLAG_CALL_REPORTED_SESSION_ID = "$flag_call_reported_session_id";
...
export declare const SDK_DEBUG_EXTENSIONS_INIT_METHOD = "$sdk_debug_extensions_init_method";
export declare const SDK_DEBUG_EXTENSIONS_INIT_TIME_MS = "$sdk_debug_extensions_init_time_ms";
export declare const SDK_DEBUG_RECORDING_SCRIPT_NOT_LOADED = "$sdk_debug_recording_script_not_loaded";
export declare const SDK_DEBUG_REPLAY_EVENT_TRIGGER_STATUS = "$sdk_debug_replay_event_trigger_status";
export declare const SDK_DEBUG_REPLAY_LINKED_FLAG_TRIGGER_STATUS = "$sdk_debug_replay_linked_flag_trigger_status";
export declare const SDK_DEBUG_REPLAY_MATCHED_RECORDING_TRIGGER_GROUPS = "$sdk_debug_replay_matched_recording_trigger_groups";
export declare const SDK_DEBUG_REPLAY_REMOTE_TRIGGER_MATCHING_CONFIG = "$sdk_debug_replay_remote_trigger_matching_config";
export declare const SDK_DEBUG_REPLAY_TRIGGER_GROUPS_COUNT = "$sdk_debug_replay_trigger_groups_count";
export declare const SDK_DEBUG_REPLAY_URL_TRIGGER_STATUS = "$sdk_debug_replay_url_trigger_status";
export declare const SDK_DEBUG_REPLAY_RRWEB_ATTACHED = "$sdk_debug_rrweb_attached";
export declare const SDK_DEBUG_REPLAY_RRWEB_START_ATTEMPTED = "$sdk_debug_rrweb_start_attempted";
export declare const SESSION_RECORDING_START_REASON = "$session_recording_start_reason";
export declare const SURVEYS_REQUEST_TIMEOUT_MS = 10000;
export declare const LOAD_EXT_NOT_FOUND = "PostHog loadExternalDependency extension not found.";
export declare const COOKIELESS_ON_REJECT: "on_reject";
export declare const COOKIELESS_ALWAYS: "always";
export declare const USER_STATE_ANONYMOUS = "anonymous";
export declare const USER_STATE_IDENTIFIED = "identified";
export declare const PERSON_PROFILES_IDENTIFIED_ONLY: "identified_only";
export declare const DOM_EVENT_VISIBILITYCHANGE = "visibilitychange";
export declare const DOM_EVENT_BEFOREUNLOAD = "beforeunload";
...
export declare const EVENT_GROUPIDENTIFY = "$groupidentify";
export declare const Z_INDEX_TOURS = 2147483646;
export declare const Z_INDEX_SURVEYS = 2147483645;
export declare const Z_INDEX_CONVERSATIONS = 2147483644;
