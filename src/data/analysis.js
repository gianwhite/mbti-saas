...
export const TYPE_ANALYSIS = {
  ...
  ENFJ: {
    ...
    fortalezas: [
      ...
      { titulo: "Presencia dual única", desc: "Proyecta fuerza y calidez simultáneamente. Esta combinación es extraordinariamente rara y genera atracción de forma casi automática." },
    ...
    atraccion: {
      ...
      descripcion: "Proyecta la combinación más buscada: alguien que lidera y que siente. No es común. El ENFJ que entiende esto usa su Fe como palanca de atracción sin perder el frame de autoridad — escucha profundamente pero no desde la necesidad de agradar, sino desde posición de fuerza.",
      maximiza: [
        "Lidera con visión, no con validación. Propone, decide, ejecuta. Que la otra persona entre a tu mundo — no construyas el tuyo alrededor del suyo.",
        "Sé selectivamente indisponible. Tu tiempo y atención tienen que ser escasos para ser valiosos. Quien siempre está disponible no genera tensión.",
      ...
      errores: [
        "Ser la pareja perfecta sin polaridad — genera admiración y respeto, pero no el tipo de tensión que produce atracción real.",
        "Convertirse en su consejero o terapeuta antes de ser su pareja. Escuchar todo sus problemas destruye la dinámica de atracción.",
        "Modificar su comportamiento según cómo reacciona la otra persona. Cada ajuste basado en su aprobación señala inseguridad."
      ],
      estrategias: [
        "En conversación, haz preguntas que nadie más hace. No sobre logros o rutinas — sobre lo que realmente mueve, asusta o fascina a la otra persona. Esa profundidad sin agenda crea conexión que se diferencia de todo.",
  ...
  INFJ: {
    ...
    atraccion: {
      ...
      errores: [
        ...
        "Convertirse en el consejero emocional en lugar de la pareja que desean. Escuchar todo es el camino más rápido hacia la zona de amigos.",
  ...
  ENFP: {
    ...
    debilidades: [
      ...
      { titulo: "Demasiado accesible", desc: "Su apertura total destruye la escasez que genera atracción sostenida. Quien está disponible para todos no tiene el mismo valor percibido que quien es selectivo." },
    ...
    compatibilidad: {
      top: [
        { tipo: "INTJ", por_que: "La tensión de opuestos más productiva del sistema. El INTJ aporta dirección, profundidad y desafío intelectual. El ENFP aporta calidez, espontaneidad y perspectiva no convencional. Ambos se fascinan y se expanden mutuamente.", como_conectar: "Muestra rigor intelectual además de creatividad. El INTJ no se impresiona con entusiasmo — se impresiona con ideas que tienen estructura." },
        { tipo: "INFJ", por_que: "Visión profunda compartida (intuición dominante en ambos) y valores alineados. El INFJ aporta profundidad emocional y visión de largo plazo; el ENFP aporta energía y conexión con el presente.", como_conectar: "Muéstrate con intención clara. El INFJ no invierte donde no ve señales de compromiso real." },
        { tipo: "ENTJ", por_que: "El ENTJ aporta la estructura, dirección y ambición que el ENFP necesita para convertir sus ideas en realidades. El ENFP humaniza al ENTJ y amplía su perspectiva de formas que ningún otro tipo logra.", como_conectar: "Demuestra que tienes proyectos reales además de ideas. El ENTJ respeta la ejecución por encima de todo." }
      ],
  ...
  INTJ: {
    ...
    compatibilidad: {
      top: [
        { tipo: "ENFP", por_que: "Tensión de opuestos altamente productiva. El ENFP trae calidez, perspectiva humana y conexión con el presente que el INTJ no genera solo. El INTJ trae estructura, profundidad y dirección que el ENFP necesita para convertir su potencial en realidad.", como_conectar: "Muestra que tienes estructura real además de profundidad. El ENFP admira la visión, pero se compromete con quien también puede ejecutarla." },
        { tipo: "ENTJ", por_que: "Dos mentes estratégicas con diferentes estilos de liderazgo. El ENTJ opera más en el mundo externo; el INTJ en la arquitectura interna. La combinación produce una potencia intelectual y operativa fuera de lo común.", como_conectar: "El ENTJ respeta la competencia demostrada. Entra en el mundo del ENTJ con ideas sólidas y la capacidad de ejecutarlas." },
        { tipo: "INFJ", por_que: "Intuición compartida profunda. Ambos operan desde Ni dominante, lo que genera una comprensión mutua casi sin palabras. El INFJ aporta la dimensión humana y emocional que el INTJ tiene menos desarrollada.", como_conectar: "Muéstrate con valores claros — el INFJ lee la alineación ética antes que cualquier otra dimensión." }
      ],
  ...
  INTP: {
    ...
    compatibilidad: {
      top: [
        { tipo: "ENTJ", por_que: "El ENTJ convierte las ideas del INTP en realidad. El INTP profundiza el pensamiento del ENTJ más allá de lo que la ejecución sola permite. Es una alianza de pensamiento y acción que produce resultados fuera de lo común.", como_conectar: "Muestra que tus ideas tienen aplicación real, no solo elegancia teórica. El ENTJ respeta la mente pero se mueve por resultados." },
        { tipo: "INFJ", por_que: "El INFJ aporta la dimensión humana y la profundidad emocional que el INTP rara vez accede solo; el INTP aporta el rigor lógico que da solidez a la visión del INFJ.", como_conectar: "El INFJ busca autenticidad. Sé genuinamente tú mismo — el INFJ lee la inautenticidad como señal de alerta inmediata." },
        { tipo: "ENTP", por_que: "Dos mentes Ne activas que pueden explorar ideas juntos durante horas sin agotarse. El placer intelectual compartido crea una conexión que pocos tipos pueden igualar con el INTP.", como_conectar: "Llega con ideas propias y el coraje de defenderlas frente al escrutinio. El ENTP en modo intelectual respeta quien puede aguantar el debate." }
      ],
  ...
  ENTJ: {
    ...
    compatibilidad: {
      top: [
        { tipo: "INTP", por_que: "El INTP profundiza el pensamiento que el ENTJ luego ejecuta. El ENTJ da al INTP el contexto de realidad y urgencia que convierte sus ideas en algo que importa más allá del ejercicio intelectual.", como_conectar: "Muestra que valoras las ideas por su rigor, no solo por su utilidad inmediata. El INTP necesita sentir que su forma de pensar es respetada." },
        { tipo: "INFJ", por_que: "El INFJ aporta profundidad humana y valores que anclan la ambición del ENTJ en algo más que el logro por el logro. El ENTJ aporta la capacidad de convertir la visión del INFJ en impacto real en el mundo.", como_conectar: "El INFJ busca alineación de valores. Muestra que hay un por qué genuino detrás de tu ambición." },
        { tipo: "INTJ", por_que: "Dos estrategas con diferentes estilos — el ENTJ domina la ejecución externa; el INTJ domina la arquitectura interna. La combinación produce una potencia intelectual y operativa excepcional.", como_conectar: "El INTJ respeta la competencia silenciosa más que la declarada. Deja que tu historial de resultados hable." }
      ],
  ...
  ENTP: {
    ...
    compatibilidad: {
      top: [
        { tipo: "INFJ", por_que: "El INFJ aporta profundidad, valores y la capacidad de anclar la exploración del ENTP en algo significativo. El ENTP expande el mundo del INFJ y desafía su pensamiento de formas que ningún otro tipo puede igualar.", como_conectar: "Muestra que bajo la exploración hay valores reales. El INFJ no invierte en quienes parecen tener solo brillo sin sustancia." },
        { tipo: "INTP", por_que: "Dos mentes con Ne activo que pueden explorar juntos indefinidamente. El INTP aporta un rigor Ti que desafía y refina las ideas del ENTP; el ENTP aporta la energía externa que el INTP raramente genera solo.", como_conectar: "Llega con rigor, no solo entusiasmo. El INTP respeta la capacidad de sostener una posición bajo análisis real." },
        { tipo: "ENFJ", por_que: "El ENFJ aporta calidez, estructura social y la capacidad de convertir las ideas del ENTP en conexión humana real. El ENTP desafía el consenso del ENFJ de formas que lo hacen crecer.", como_conectar: "Muéstrate genuinamente comprometido con el bienestar de las personas que importan. El ENFJ necesita ver que el brillo del ENTP está al servicio de algo más que el juego intelectual." }
      ],
  ...
  ISTJ: {
    ...
    compatibilidad: {
      top: [
        { tipo: "ESFJ", por_que: "El ESFJ aporta la calidez social y la orientación hacia las personas que el ISTJ tiene menos desarrollada. El ISTJ aporta la solidez estructural y la confiabilidad que el ESFJ necesita como base para su mundo relacional.", como_conectar: "Muestra consistencia y fiabilidad. El ESFJ valora profundamente sentirse seguro con alguien." },
        { tipo: "ISFJ", por_que: "Dos tipos Si dominantes que comparten la misma orientación hacia la responsabilidad y la confiabilidad. Profunda comprensión mutua sin necesidad de traducción. La diferencia Fe/Te aporta complementariedad en los estilos de expresión.", como_conectar: "Demuestra cuidado genuino a través de acciones concretas. El ISFJ lee el amor en los detalles del servicio." },
        { tipo: "ESTJ", por_que: "Orientación compartida hacia la responsabilidad, los sistemas y la ejecución. Ambos operan desde Te y comparten valores de integridad y competencia. La diferencia Si/Se aporta perspectivas complementarias.", como_conectar: "Muestra rigor en tu propio dominio. El ESTJ respeta la competencia demostrada por encima de cualquier otra señal." }
      ],
  ...
  ESFJ: {
    ...
    compatibilidad: {
      top: [
        { tipo: "ISFJ", por_que: "Dos tipos Si con orientación hacia el cuidado (Fe auxiliar en ISFJ, Fe dominante en ESFJ). Comprensión profunda y mutua de la forma en que el amor se expresa. El ESFJ aporta energía social expansiva; el ISFJ aporta profundidad interior.", como_conectar: "Muéstrate cálido y genuinamente interesado en el bienestar de las personas que le importan." },
        { tipo: "ISTJ", por_que: "El ISTJ aporta la solidez estructural y la confiabilidad que el ESFJ necesita como base. El ESFJ aporta la calidez y el tejido relacional que el ISTJ tiene menos desarrollado. Complementariedad profunda.", como_conectar: "Demuestra confiabilidad sostenida. El ISTJ se convierte en anclaje para el ESFJ que más lo necesita." },
        { tipo: "ENFJ", por_que: "Dos tipos Fe con visión y orientación hacia las personas. El ENFJ aporta profundidad intuitiva y visión de largo plazo; el ESFJ aporta cuidado práctico y construcción de comunidad concreta.", como_conectar: "El ENFJ busca alineación de valores y dirección. Muestra que tu cuidado está al servicio de algo más que la armonía inmediata." }
      ],
  ...
  ISTP: {
    ...
    compatibilidad: {
      top: [
        { tipo: "ESTP", por_que: "Dos tipos Se con Ti/Fe compartidos en diferente orden. El ESTP aporta la energía social externa que el ISTP raramente genera; el ISTP aporta la profundidad de análisis que el ESTP necesita para dar solidez a su acción.", como_conectar: "El ESTP respeta la competencia y la presencia. Muestra lo que sabes hacer." },
        { tipo: "ISFP", por_que: "Complementariedad entre Ti y Fi, con Se compartido. El ISFP aporta la profundidad emocional y la autenticidad de valores que el ISTP tiene menos desarrollada; el ISTP aporta la capacidad analítica y la estabilidad bajo presión.", como_conectar: "El ISFP necesita sentir que es visto en su autenticidad. Sé genuino y presente." },
        { tipo: "ENTJ", por_que: "El ENTJ provee la dirección de largo plazo y la estructura que el ISTP raramente genera solo. El ISTP provee la competencia técnica de ejecución que el ENTJ necesita para hacer real su visión.", como_conectar: "Muestra competencia en tu dominio. El ENTJ construye alianzas con quien puede ejecutar, no solo con quien puede imaginar." }
      ],
  ...
  ESTP: {
    ...
    compatibilidad: {
      top: [
        { tipo: "ISTP", por_que: "Se compartido con Ti/Fe en diferente expresión. Profunda comprensión mutua del presente, la acción y la independencia. El ISTP aporta profundidad de análisis; el ESTP aporta energía social y expansión.", como_conectar: "El ISTP respeta la competencia real. Muestra lo que sabes hacer, no lo que dices que podrías hacer." },
        { tipo: "ESFP", por_que: "Se dominante compartido. Orientación mutua hacia la presencia y la experiencia. El ESFP aporta calidez emocional y conexión afectiva; el ESTP aporta rigor analítico y estabilidad bajo presión.", como_conectar: "El ESFP conecta con quien puede crear experiencias de calidad. Muéstrate presente y dispuesto a explorar." },
        { tipo: "ISFP", por_que: "Se compartido con Fi/Ti complementarios. El ISFP aporta profundidad de valores y autenticidad; el ESTP aporta energía y expansión del presente. La diferencia de introversión-extroversión crea una complementariedad real.", como_conectar: "El ISFP valora la autenticidad sobre todo. Muéstrate genuinamente tú mismo, sin performance." }
      ],
  ...
  ESFP: {
    ...
    compatibilidad: {
      top: [
        { tipo: "ISFP", por_que: "Se compartido con Fi complementario. El ISFP aporta profundidad de valores y espacio de quietud que el ESFP necesita; el ESFP aporta la energía social y la expansión del mundo que el ISFP raramente genera solo.", como_conectar: "El ISFP valora la autenticidad absoluta. Sé genuinamente tú mismo en cada momento." },
        { tipo: "ESTP", por_que: "Se dominante compartido — presencia y presente. El ESTP aporta rigor analítico y estabilidad bajo presión; el ESFP aporta calidez emocional y orientación hacia las personas. Complementariedad potente.", como_conectar: "El ESTP respeta quien puede seguir su ritmo sin perderse a sí mismo. Muéstrate presente y capaz." },
        { tipo: "ESFJ", por_que: "Se y Fe compartidos en diferente configuración. El ESFJ aporta estructura, tradición y cuidado concreto; el ESFP aporta espontaneidad, energía y presencia luminosa. La combinación crea calidez y vitalidad simultáneas.", como_conectar: "El ESFJ valora quien es consistente y genuinamente cálido. Muéstrate presente y considera las necesidades del entorno relacional." }
      ],
